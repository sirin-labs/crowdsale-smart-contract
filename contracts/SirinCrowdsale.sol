...
contract SirinCrowdsale is FinalizableCrowdsale {
    ...
    function finalization() internal {
        ...
        token.issue(0x00803306C76b1bf476cdCe3b308e146Ee1D201B4, SafeMath.div(SafeMath.mul(totalSupply, 250),1000));
        ...
        token.issue(0x00eB0E5f489d90455d7BF202fF1a638f510E276b, SafeMath.div(SafeMath.mul(totalSupply, 250),1000));

        //12.5% from totalSupply which is 5% of the total number of SRN tokens will be allocated to professional fees and Bounties
        token.issue(0x0059e796c5Bc1F15B9310a8461deBADDC8F8af21, SafeMath.div(SafeMath.mul(totalSupply, 125),1000));
        ...
        token.issue(0x00522Ea95d76DFC9AaA8A25B3DD33Ef2d5c86929, SafeMath.div(SafeMath.mul(totalSupply, 875),1000));
